...
<head>
    ...
    <style>
        ...
        .wishlist-shell { padding:42px 0 70px; }
        .wishlist-panel { background:#fff; border:1px solid rgba(15,23,42,.08); border-radius:8px; box-shadow:0 18px 45px rgba(15,23,42,.08); overflow:hidden; }
        .wishlist-header { padding:24px; border-bottom:1px solid #eef2f7; display:flex; justify-content:space-between; gap:16px; flex-wrap:wrap; }
        .wishlist-header h1 { margin:0; font-weight:900; }
        .wishlist-item { display:grid; grid-template-columns:92px minmax(0,1fr) auto; gap:18px; align-items:center; padding:20px 24px; border-bottom:1px solid #eef2f7; }
        .wishlist-item img { width:92px; height:92px; object-fit:cover; border-radius:8px; background:#f1f5f9; }
        .wishlist-item h3 { margin:0 0 4px; font-size:1.05rem; font-weight:900; }
        .wishlist-item h3 a { color:inherit; text-decoration:none; }
        .wishlist-meta { color:#64748b; font-size:.92rem; }
        .wishlist-price { margin-top:8px; color:#b91c1c; font-weight:900; font-size:1.1rem; }
        .wishlist-actions { display:flex; align-items:center; justify-content:flex-end; gap:10px; flex-wrap:wrap; }
        ...
        .danger-action { min-height:44px; border:1px solid #fecaca; background:#fff; color:#dc2626; border-radius:8px; padding:0 14px; font-weight:800; }
        .danger-action:hover { background:#fef2f2; }
        .wishlist-empty { padding:60px 24px; color:#64748b; text-align:center; }
        @media(max-width:700px){ .wishlist-item{grid-template-columns:78px minmax(0,1fr)} .wishlist-item img{width:78px;height:78px}.wishlist-actions{grid-column:1 / -1; justify-content:flex-start} }
    </style>
</head>
<body>
