...
<head>
    ...
    <style>
        ...
        .cart-shell { padding: 42px 0 70px; }
        .cart-panel { background:#fff; border:1px solid rgba(15,23,42,.08); border-radius:8px; box-shadow:0 18px 45px rgba(15,23,42,.08); overflow:hidden; }
        .cart-header { padding:24px; border-bottom:1px solid #eef2f7; display:flex; justify-content:space-between; gap:16px; flex-wrap:wrap; }
        .cart-header h1 { margin:0; font-weight:900; }
        .cart-select-row { padding:16px 24px; border-bottom:1px solid #eef2f7; display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap; }
        .cart-check-label { display:inline-flex; align-items:center; gap:10px; color:#334155; font-weight:800; cursor:pointer; }
        .cart-check { width:20px; height:20px; accent-color:#16a34a; cursor:pointer; }
        .cart-item { display:grid; grid-template-columns:24px 88px minmax(0,1fr) auto; gap:18px; padding:20px 24px; border-bottom:1px solid #eef2f7; align-items:center; }
        .cart-item img { width:88px; height:88px; object-fit:cover; border-radius:8px; background:#f1f5f9; }
        .cart-item h3 { margin:0 0 4px; font-size:1rem; font-weight:900; }
        .cart-meta { color:#64748b; font-size:.9rem; }
        .cart-actions { display:flex; align-items:center; gap:10px; justify-content:flex-end; flex-wrap:wrap; }
        .cart-qty-wrap { display:inline-flex; align-items:center; border:1px solid #dbe3ec; border-radius:8px; overflow:hidden; background:#fff; }
        .cart-qty-btn { width:36px; height:38px; border:0; background:#f8fafc; color:#0f172a; font-weight:900; }
        ...
        .cart-empty { padding:54px 24px; text-align:center; color:#64748b; }
        .primary-action { min-height:44px; display:inline-flex; align-items:center; justify-content:center; gap:8px; padding:0 18px; border:1px solid #16a34a; border-radius:8px; background:#16a34a; color:#fff; font-weight:800; text-decoration:none; }
        ...
        .secondary-action { min-height:44px; display:inline-flex; align-items:center; justify-content:center; gap:8px; padding:0 18px; border:1px solid #dbe3ec; border-radius:8px; background:#fff; color:#111827; font-weight:800; text-decoration:none; }
        .secondary-action:hover { color:#1665d8; border-color:#b9c9ef; }
        .checkout-inline { margin-top:0; background:#fff; border-top:1px solid #eef2f7; overflow:hidden; }
        .checkout-inline[hidden] { display:none; }
        .checkout-inline-header { display:none; }
        .checkout-inline-body { padding:24px; }
        .checkout-inline-footer { padding:18px 24px; border-top:1px solid #eef2f7; display:flex; justify-content:flex-end; gap:12px; flex-wrap:wrap; }
        .checkout-table-wrap { display:none; }
        .checkout-table { width:100%; min-width:760px; margin:0; border-collapse:collapse; }
        .checkout-table th { background:#eef1f5; color:#111827; font-size:.9rem; padding:12px; border-bottom:1px solid #d7dde6; }
        .checkout-table td { padding:12px; border-bottom:1px solid #eef2f7; vertical-align:middle; }
        .checkout-table tr:last-child td { border-bottom:0; }
        .checkout-thumb { width:58px; height:58px; object-fit:cover; border-radius:8px; background:#f1f5f9; }
        .checkout-product-name { font-weight:900; color:#111827; }
        .checkout-small { color:#64748b; font-size:.86rem; }
        .checkout-amount { color:#111827; font-weight:900; text-align:right; white-space:nowrap; }
        .checkout-delivery { margin-top:22px; }
        .checkout-delivery h3 { font-size:1.1rem; font-weight:900; margin:0 0 14px; }
        .checkout-summary-box { background:#f8fafc; border:1px solid #e5eaf0; border-radius:8px; padding:16px; }
        .checkout-summary-line { display:flex; justify-content:space-between; gap:16px; margin-bottom:8px; color:#475569; }
        .checkout-summary-line strong { color:#111827; }
        .checkout-summary-total { display:flex; justify-content:space-between; gap:16px; padding-top:10px; border-top:1px solid #dbe3ec; color:#111827; font-size:1.15rem; font-weight:900; }
        .checkout-payment-block { padding:0 24px 18px; }
        .payment-methods { margin-top:20px; display:grid; gap:10px; }
        .payment-option { display:flex; align-items:flex-start; gap:12px; padding:14px; border:1px solid #dbe3ec; border-radius:8px; background:#fff; cursor:pointer; }
        .payment-option.is-selected { border-color:#16a34a; background:#f0fdf4; }
        .payment-option input { margin-top:4px; accent-color:#16a34a; }
        .payment-option strong { display:block; color:#111827; }
        .payment-option span span { display:block; color:#64748b; font-size:.88rem; margin-top:2px; }
        .sandbox-box { margin-top:14px; padding:14px; border:1px dashed #94a3b8; border-radius:8px; background:#f8fafc; }
        .sandbox-box[hidden] { display:none; }
        .sandbox-code { display:inline-flex; align-items:center; gap:8px; margin-top:8px; padding:8px 10px; border-radius:8px; background:#111827; color:#fff; font-weight:800; letter-spacing:.04em; }
        @media(max-width:700px){ .cart-item{grid-template-columns:24px 72px minmax(0,1fr)} .cart-item img{width:72px;height:72px}.cart-actions{grid-column:2 / -1; justify-content:flex-start}.cart-price{text-align:left} }
    </style>
</head>
<body>
