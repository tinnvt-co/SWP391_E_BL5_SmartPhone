...
<head>
    ...
    <style>
        ...
        .review-shell { padding:32px 0 70px; }
        .review-panel { background:#fff; border:1px solid rgba(15,23,42,.08); border-radius:8px; box-shadow:0 18px 45px rgba(15,23,42,.08); padding:24px; margin-bottom:18px; }
        .review-title { font-weight:900; margin:0 0 4px; }
        .review-sub { color:#64748b; font-size:.9rem; }
        .review-toolbar { display:flex; gap:8px; flex-wrap:wrap; align-items:center; }
        .review-toolbar .form-select, .review-toolbar .form-control { min-width:180px; }
        .review-table { width:100%; border-collapse:collapse; }
        .review-table th, .review-table td { padding:12px 10px; border-bottom:1px solid #eef2f7; vertical-align:top; font-size:.92rem; }
        .review-table th { background:#f8fafc; color:#475569; font-weight:700; font-size:.78rem; text-transform:uppercase; letter-spacing:.4px; text-align:left; }
        .review-table tr:last-child td { border-bottom:none; }
        .badge-rating { display:inline-block; padding:3px 9px; background:#fef3c7; color:#92400e; border-radius:999px; font-weight:800; font-size:.78rem; }
        ...
        .thread { background:#fff; border:1px solid rgba(15,23,42,.08); border-radius:8px; box-shadow:0 18px 45px rgba(15,23,42,.08); padding:24px; }
        .thread h2 { margin:0 0 6px; font-weight:900; }
        .thread-meta { color:#64748b; font-size:.9rem; margin-bottom:18px; }
        ...
        .thread-bubble-head { display:flex; justify-content:space-between; align-items:flex-start; gap:8px; margin-bottom:6px; }
        .thread-bubble-author { font-weight:800; color:#0f172a; }
        .thread-bubble-role { font-size:.72rem; text-transform:uppercase; letter-spacing:.4px; color:#475569; margin-left:6px; }
        .thread-bubble-time { color:#64748b; font-size:.8rem; }
        .thread-bubble-content { white-space:pre-wrap; color:#0f172a; }
        ...
        @media(max-width:760px){
            ...
            .review-table tr { padding:12px 0; }
            .review-table td { padding:6px 0; border:none; }
