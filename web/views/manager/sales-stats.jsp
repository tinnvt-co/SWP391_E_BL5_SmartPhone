...
<!DOCTYPE html><html><head><title>Sales Statistics</title><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
        ...
        <style>
            ...
            .chart-row .bar{
                flex:1;
                background:linear-gradient(180deg,var(--blue),#2b5db8);
            ...
            .chart-row .bar:hover{
                background:linear-gradient(180deg,#6594f1,var(--blue))
            }
            .chart-row .bar .val{
                position:absolute;
                top:-22px;
            ...
            .brand-bar-row:first-child{
                border-top:none
            }
            .brand-bar-row .brand-name{
                width:130px;
                font-weight:600;
                flex-shrink:0;
                font-size:14px
            }
            .brand-bar-row .bar-track{
                flex:1;
                height:10px;
                background:#1a2030;
                border-radius:6px;
            ...
            .brand-bar-row .bar-fill{
                height:100%;
                background:linear-gradient(90deg,var(--blue),#5d8ffc);
                border-radius:6px
            }
            .brand-bar-row .brand-rev{
                width:140px;
                text-align:right;
                font-weight:700;
                font-family:'Roboto Slab',serif;
