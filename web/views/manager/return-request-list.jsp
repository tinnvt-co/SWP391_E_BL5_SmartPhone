...
<head>
    ...
    <style>
        ...
        .rr-shell { padding:32px 0 70px; }
        .rr-panel { background:#fff; border:1px solid rgba(15,23,42,.08); border-radius:8px; box-shadow:0 18px 45px rgba(15,23,42,.08); padding:24px; margin-bottom:18px; }
        .rr-title { font-weight:900; margin:0 0 4px; }
        .rr-sub { color:#64748b; font-size:.9rem; }
        .rr-table { width:100%; border-collapse:collapse; }
        .rr-table th, .rr-table td { padding:12px 10px; border-bottom:1px solid #eef2f7; vertical-align:top; font-size:.92rem; }
        .rr-table th { background:#f8fafc; color:#475569; font-weight:700; font-size:.78rem; text-transform:uppercase; letter-spacing:.4px; text-align:left; }
        ...
        .status-pill.status-active   { background:#fef3c7; color:#92400e; border-color:#fde68a; }
        .status-pill.status-approved { background:#dcfce7; color:#166534; border-color:#86efac; }
        ...
        .thread-bubble-author { font-weight:800; }
        .thread-bubble-role { font-size:.72rem; text-transform:uppercase; letter-spacing:.4px; color:#475569; margin-left:6px; }
        .item-row { display:flex; gap:12px; padding:10px 0; border-bottom:1px dashed #eef2f7; }
