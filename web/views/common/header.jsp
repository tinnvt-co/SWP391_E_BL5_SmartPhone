...
<header class="swp-layout-header">
    ...
    <nav class="swp-layout-nav">
        <div class="swp-layout-container swp-layout-nav-inner">
            ...
            <button class="swp-layout-toggler navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mainNav"
            ...
            <div class="swp-layout-collapse collapse navbar-collapse" id="mainNav">
                <ul class="swp-layout-links">
                    <li>
                        <a class="swp-layout-link ${activePage == 'home' ? 'is-active' : ''}" href="${pageContext.request.contextPath}/home">Home</a>
                    </li>
                    <li>
                        <a class="swp-layout-link ${activePage == 'products' ? 'is-active' : ''}" href="${pageContext.request.contextPath}/products">Products</a>
                    </li>
                    <li>
                ...
                <div class="swp-layout-actions">
                    ...
                    <c:choose>
                        <c:when test="${not empty currentUser}">
                            <div class="dropdown">
                                <button class="swp-layout-action swp-layout-action-secondary dropdown-toggle" type="button"
                        ...
                        <c:otherwise>
                            <a class="swp-layout-action swp-layout-action-secondary" href="${pageContext.request.contextPath}/login">
                                <i class="bi bi-box-arrow-in-right"></i> Login
                            </a>
                        </c:otherwise>
                    </c:choose>
                    <a class="swp-layout-action swp-layout-action-primary" href="${pageContext.request.contextPath}/products">
