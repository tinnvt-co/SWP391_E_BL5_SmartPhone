            ...
            <div class="swp-layout-container swp-layout-nav-inner">
                ...
                <div class="swp-layout-collapse collapse navbar-collapse" id="mainNav">
                    <ul class="swp-layout-links">
                        ...
                        <li>
                            <a class="swp-layout-link"
                                href="${pageContext.request.contextPath}/home#categories">Categories</a>
                        </li>
                        <li>
                            <a class="swp-layout-link"
                                href="${pageContext.request.contextPath}/home#services">Services</a>
                        </li>
                    ...
                    <div class="swp-layout-actions">
                        ...
                        <button class="swp-layout-icon-btn" type="button" title="Search"><i
                                class="bi bi-search"></i></button>
                        <button class="swp-layout-icon-btn" type="button" title="Wishlist"><i
                                class="bi bi-heart"></i></button>
                        <button class="swp-layout-icon-btn" type="button" title="Cart"><i
