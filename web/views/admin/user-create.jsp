...
<html lang="en">
    <head>
        ...
        <title>Create New User | SmartPhone store</title>
                ...
                <div class="dashboard-grid">
                    ...
                    <section class="panel content-panel">
                        <div class="mb-4 d-flex align-items-center gap-3">
                            ...
                            <h2 class="h4 fw-bold mb-0">User Details</h2>
                        </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" value="${param.username}" required
                                           placeholder="Alphanumeric, 4-20 chars">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="${param.name}" required maxlength="50"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="age" name="age" value="${param.age}" min="10" max="100"
                                           placeholder="10 - 100">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="3" placeholder="Optional">${param.address}</textarea>
                                </div>
                            </div>
                            <hr class="my-4">
