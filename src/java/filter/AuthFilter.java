...
public class AuthFilter implements Filter {
    ...
    private static final List<AccessRule> ACCESS_RULES = List.of(
            ...
            rule("/customer/chat", perms("ORDER_HISTORY_VIEW")),
            rule("/customer/complete-order", perms("ORDER_HISTORY_VIEW")),
            rule("/chat-realtime", perms("ORDER_HISTORY_VIEW", "CHAT_MANAGE", "CHAT_VIEW")),
            rule("/manager/chat", perms("CHAT_MANAGE", "CHAT_VIEW")),
