...
public class AuthFilter implements Filter {
    ...
    private static final List<AccessRule> ACCESS_RULES = List.of(
            ...
            rule("/customer/cancel-request", perms("ORDER_HISTORY_VIEW")),
            rule("/customer/complaint", perms("ORDER_HISTORY_VIEW")),
            rule("/customer/complete-order", perms("ORDER_HISTORY_VIEW")),
            rule("/complaint-realtime", perms("ORDER_HISTORY_VIEW", "COMPLAINT_VIEW", "COMPLAINT_MANAGE")),
            rule("/manager/complaint", perms("COMPLAINT_MANAGE", "COMPLAINT_VIEW")),
