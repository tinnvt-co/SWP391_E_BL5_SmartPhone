...
public class StockModel implements Serializable {
    ...
    public int getImportPrice() { return importPrice; }
    public void setImportPrice(int importPrice) { this.importPrice = importPrice; }
    ...
    public long getStockValue() { return (long) stock * importPrice; }
    ...
    public int getMinAmount() { return lowStockThreshold; }
    public void setMinAmount(int v) { this.lowStockThreshold = v; }
    public Integer getMaxAmount() { return null; }
}
