 ...
 *
 * Lifecycle status values (stored in ReturnRequest.Status):
 *   - ACTIVE   : customer just submitted, waiting for manager review
 *   - APPROVED : manager approved, items will be returned / refunded
...
public class ReturnRequestModel implements Serializable {
    ...
    public List<ReturnRequestItemModel> getItems() { return items; }
    public void setItems(List<ReturnRequestItemModel> items) { this.items = items; }

    public boolean isPending() { return STATUS_ACTIVE.equalsIgnoreCase(status); }
    ...
    public String getStatusLabel() {
        ...
        switch (status.toUpperCase()) {
            case STATUS_ACTIVE:   return "Pending review";
